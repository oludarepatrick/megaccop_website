...
const sections = [
  ...
  {
    id: "membershipRights",
    title: "Membership Rights and Controls",
    number: 5,
  },
  {
    id: "dataSharing",
    title: "Data Sharing and Third-Party Requirements",
    number: 6,
  },
  {
    id: "internationalMember",
    title: "International Member Consideration",
    number: 7,
  },
  {
    id: "incidentResponse",
  ...
  },
  {
    ...
    title: "System Development Requirements",
    number: 9,
  },
  {
    id: "implementationGuidelines",
    title: "Implementation Guidelines for Development Team",
    number: 10,
  },
...
export default function PrivacyPolicy() {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* hero section */}
      <div
        className="relative top-[-105px] h-100 w-full bg-cover bg-center object-cover"
        style={{ backgroundImage: `url(${privacypolicyimage})` }}
      >
        <h2 className="absolute inset-0 bg-black/50 flex items-center justify-center text-white text-3xl lg:text-5xl font-semibold">
          Privacy Policy
        </h2>
      </div>
      {/* Mobile Menu Button */}
      ...
      <div className="flex mt-[-100px]">
        ...
        <main className="flex-1 lg:ml-0 min-h-screen">
          <div className="max-w-4xl mx-auto p-6 lg:p-12">
            <p className="text-sm  mb-4 text-[#82A605]">
            ...
            <section id="Introduction" className="mb-16">
              ...
              <div className="prose prose-gray max-w-none">
                <p className="text-foreground mb-2">
                  This Privacy Policy governs the collection, use, processing,
                  and protection of personal and financial data within
                  MegaCoop's digital systems. This policy applies to all
                  software systems, applications, and digital platforms
                  developed for or integrated with MegaCoop's operations.
                </p>
                <p className="text-foreground mb-2">
                  <strong className="text-green-600">
                    Regulatory Compliance:
                  </strong>{" "}
                  This policy ensures compliance with the Nigeria Data
                  Protection Regulation (NDPR) 2019, Central Bank of Nigeria
                  (CBN) guidelines for financial institutions, and international
                  data protection standards for our international members.
                </p>
              </div>
            </section>
                ...
                <ul className="list-none list-inside space-y-1 text-foreground ml-4">
                  <li>
                    ...
                    <ul className="list-disc list-inside ml-6 mt-2">
                      ...
                      <li>
                        Date of birth, nationality, identification numbers (NIN,
                        BVN, International ID)
                      </li>
                  ...
                  <li>
                    <strong className="text-green-600">Financial Data:</strong>
                    <ul className="list-disc list-inside ml-6 mt-2">
                      <li>
                        Account balances, transaction histories, payment records
                      </li>
                      <li>
                        Loan applications, credit assessments, repayment
                        schedules
                      </li>
                  ...
                  <li>
                    <strong className="text-green-600">Technical Data:</strong>
                    <ul className="list-disc list-inside ml-6 mt-2">
            ...
            <section id="dataCollection" className="mb-16">
              ...
              <div className="mb-8">
                ...
                <ul className="list-disc list-inside space-y-1 text-foreground ml-4">
                  <li>
                    Contractual necessity: Processing required for membership
                    services
                  </li>
                  <li>
                    Legal obligation: Compliance with CBN, FIRS, and other
                    regulatory requirements
                  </li>
                  <li>
                    Legitimate interests: Fraud prevention, risk assessment,
                    service improvement
                  </li>
                  <li>
                    Consent: Where explicitly required by law or additional
                    services
                  </li>
                </ul>
              </div>
              ...
              <div className="mb-8">
                ...
                <ul className="list-disc list-inside space-y-1 text-foreground ml-4">
                  <li>
                    Collect only data necessary for specified cooperative
                    functions
                  </li>
            ...
            <section id="dataProcessing" className="mb-16">
              ...
              <div className="mb-8">
                <h3 className="text-l font-semibold text-green-600 mb-4">
                  4.1 System Security Standard
                </h3>

                <h4 className="text-md font-semibold text-green-600 mb-2 ml-4">
                ...
                <h4 className="text-md font-semibold text-green-600 mb-2 ml-4 mt-4">
                  Access Controls:
                </h4>
                <ul className="list-disc list-inside space-y-1 text-foreground ml-8">
              ...
              <div className="mb-8">
                ...
                <ul className="list-disc list-inside space-y-1 text-foreground ml-4">
                  <li>
                    Active Member Records: Retained during membership + 7 years
                  </li>
                  <li>
                    Financial Transaction Records: 10 years (CBN requirement)
                  </li>
            ...
            <section id="membershipRights" className="mb-16">
              <h2 className="text-xl font-bold text-green-600 mb-8">
                5. MEMBERSHIP RIGHTS AND CONTROLS
              </h2>

              <div className="mb-8">
                <h3 className="text-l font-semibold text-green-600 mb-4">
                  5.1 Data Subject Rights (NDPR Compliance)
                </h3>
                ...
                <ul className="list-disc list-inside space-y-1 text-foreground ml-8">
                  <li>
                    Right to erasure after membership termination (subject to
            ...
            <section id="dataSharing" className="mb-16">
              <h2 className="text-xl font-bold text-green-600 mb-8">
                6. DATA SHARING AND THIRD PARTY REQUIREMENTS
              </h2>
              ...
              <div className="mb-8">
                ...
                <ul className="list-disc list-inside space-y-1 text-foreground ml-4">
                  <li>
                    Between MegaCoop entities: Investment arm and Credit Union
                    arm
                  </li>
                  <li>
                    Data sharing agreements with clear purposes and limitations
                  </li>
              ...
              <div className="mb-8">
                ...
                <ul className="list-disc list-inside space-y-1 text-foreground ml-8">
                  <li>
                    Regulatory authorities (CBN, NDPC, FIRS) as legally required
                  </li>
                  <li>Credit bureaus for credit assessment (with consent)</li>
                  <li>National Housing Fund administrators</li>
                  <li>
                    Select suppliers for goods procurement (limited data only)
                  </li>
                  <li>
                    Legal advisors and auditors (under confidentiality
                    agreements)
                  </li>
                </ul>
              ...
              <div className="mb-8">
                ...
                <ul className="list-disc list-inside space-y-1 text-foreground ml-4">
                  ...
                  <li>
                    Implement security measures equivalent to MegaCoop standards
                  </li>
                  <li>
                    Limited access to production data (use synthetic data for
                    testing)
                  </li>
            ...
            <section id="internationalMember" className="mb-16">
              <h2 className="text-xl font-bold text-green-600 mb-8">
                7. INTERNATIONAL MEMBER CONSIDERATION
              </h2>
              ...
              <div className="mb-8">
                ...
                <ul className="list-disc list-inside space-y-1 text-foreground ml-4">
                  <li>
                    Adequacy assessments for international member countries
                  </li>
                  <li>
            ...
            <section id="systemDevelopment" className="mb-16">
              <h2 className="text-xl font-bold text-green-600 mb-8">
                9. SYSTEM DEVELOPMENT REQUIREMENTS
              </h2>
            ...
            <section id="implementationGuidelines" className="mb-16">
              <h2 className="text-xl font-bold text-green-600 mb-8">
                10. IMPLEMENTATION GUIDELINE FOR DEVELOPMENT TEAM
              </h2>
            ...
            <section id="complianceMonitoring" className="mb-16">
              ...
              <div className="mt-8 p-4 bg-green-50 rounded-lg">
                ...
                <ul className="list-disc list-inside  space-y-1 text-foreground">
                  ...
                  <li>
                    <strong className="text-green-600">Member Services:</strong>{" "}
                    support@megacoop.ng
                  </li>
                </ul>
              </div>
