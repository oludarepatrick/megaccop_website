    ...
    return(
      ...
      <div className="min-h-screen bg-background flex flex-col mx-auto lg:pl-8 md:pl-12 px-4">
        <motion.h2
          ...
          className="text-2xl sm:text-3xl md:text-4xl font-bold pt-8 text-balance w-full xl:pl-4 2xl:pl-32  p-2 text-center md:text-left max-w-5xl "
        >
          Smart, Simple Services to Power<br /> Your Financial Journey
        </motion.h2>
      <motion.p
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.2 }}
          className="mt-4 text-base sm:text-lg text-muted-foreground w-full md:w-[57%] xl:pl-4  2xl:pl-32 text-center pl-2 md:text-left text-balance max-w-7xl "
        >
