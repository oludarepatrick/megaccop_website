    ...
    <section className=" px-4 bg-muted/30">
      <div className="max-w-7xl mx-auto font-poppins">
        <motion.h2
          ...
          className="text-2xl sm:text-3xl md:text-4xl font-medium pt-8 text-balance w-full md:w-[65%] p-4 text-center md:text-left"
        >
        ...
        >
          From saving and borrowing to shopping and housing support MegaCoop
          gives you tools to take control of your money.
        </motion.p>
        <FeatureCards />
        <ServiceGrid />
        <Download />
