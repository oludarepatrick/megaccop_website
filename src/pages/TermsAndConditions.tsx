...
export default function TermsAndConditions() {
    ...
    useEffect(() => {
        const handleScroll = () => {
            const scrollPosition = window.scrollY + 100 // Adjusted offset as needed
    ...
    return (
        ...
        >
            ...
            <div className="flex mt-[-90px]">
                ...
                <aside
                    className={`
          fixed lg:sticky top-0 left-0 h-screen w-93 bg-background border-r border-border overflow-y-auto z-140 transition-transform duration-300
        ...
        `}
                >
                  ...
                  `}
                    ...
                    ${activeSection === "acknowledgment" ? "bg-[#BACD7C]/[0.52] text-green-700 border border-green-200" : "hover:bg-muted border text-muted-foreground hover:text-foreground"}
                `}
