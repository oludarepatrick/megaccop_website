        ...
        <div className="grid grid-cols-1  gap-2 items-start">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-bold leading-tight text-[rgba(30,30,30,0.9)] w-3/4">
              Get in touch with us. <span className="lg:block">We're here to assist you.</span>
            </h1>

            <p className="mt-6 text-muted-foreground max-w-xl">
              Need help or have questions about your cooperative account, loans, savings or the app?
              Send us a message and our support team will reach out promptly.
            </p>
            ...
            <Card className="bg-white/5 border border-white/6 backdrop-blur-sm">
                ...
                <form ref={formRef} onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      className="bg-transparent border-0 rounded-none px-0 py-2 placeholder:text-black/60 text-black
                        focus:outline-none focus:ring-0 focus:border-b focus:border-0 border-b  border-black/20"
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      className="bg-transparent border-0 rounded-none px-0 py-2 placeholder:text-black/60 text-black
                                 focus:ring-0 focus:border-b focus:border-0 border-b border-black/20"
                  ...
                  <div >
                    ...
                    />
                    {errors.phone && (
                      <p className="text-rose-400 text-sm mt-1">{errors.phone.message}</p>
                    )}
                  </div>
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      rows={5}
                      className="bg-transparent border-0 rounded-none px-0 py-2 placeholder:text-black/60 text-black
                                 focus:ring-0 focus:border-b focus:border-0 border-b border-black/20 resize-none"
                      aria-invalid={!!errors.message}
                    />
                    {errors.message && (
                      <p className="text-rose-400 text-sm mt-1">{errors.message.message}</p>
                    )}
                  </div>
              ...
              >
                {isSubmitting ? "Sending..." : "Leave us a Message →"}
                    ...
                    {isSubmitSuccessful && (
                      <p className="text-green-400 text-sm mt-3">✅ Message sent — we'll be in touch.</p>
                    )}
                  </div>
                </form>
              </CardContent>
